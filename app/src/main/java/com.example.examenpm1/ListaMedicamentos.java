...
public class ListaMedicamentos extends AppCompatActivity {
    ...
    ArrayList<com.example.ExamenIIIPM1.dbSqlite.Medicamentos> listaMedicamentos;
    Integer listrowposition;
    Button btnModificar, btnEliminar;
    com.example.ExamenIIIPM1.ConexionSqlite conn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        conn = new com.example.ExamenIIIPM1.ConexionSqlite(getApplicationContext(), Transacciones.NameDataBase, null, 1);
    ...
    private void enviarValoresPantallaModificar(){
        ...
        try {
            ...
            Intent pantallaActualizar = new Intent(this, com.example.ExamenIIIPM1.ModificarMedicamentos.class);
    ...
    private void consultarListaMedicamentos() {
        ...
        com.example.ExamenIIIPM1.dbSqlite.Medicamentos medicamentos = null;
        listaMedicamentos = new ArrayList<com.example.ExamenIIIPM1.dbSqlite.Medicamentos>();
        Bitmap bt = null;
        Cursor cursor = db.rawQuery("SELECT * FROM " + Transacciones.tablamedicamentos, null);
        while(cursor.moveToNext()) {
            medicamentos = new com.example.ExamenIIIPM1.dbSqlite.Medicamentos();
